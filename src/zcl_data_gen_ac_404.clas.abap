class zcl_data_gen_ac_404 definition
  public
  final
  create public .
...
" testing new change in GitHub
    data: lt_acc_categ type table of ztacc_catg_c404,
          lt_catego    type table of ztcatego_c404,
          lt_clientes  type table of ztclientes_c404,
          lt_clnts_lib type table of ztclnts_lib_c404,
          lt_libros    type table of ztlibros_c404.
...
******** ztacc_catg_c404 ********
    ...
    delete from ztacc_catg_c404.
    insert ztacc_catg_c404 from table @lt_acc_categ.
...
******** ztcatego_c404 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztcatego_c404.
    insert ztcatego_c404 from table @lt_catego.
...
******** ztclientes_c404 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztclientes_c404.
    insert ztclientes_c404 from table @lt_clientes.
...
******** ztclnts_lib_c404
    ...
    "Delete possible entries; insert new entries
    delete from ztclnts_lib_c404.
    insert ztclnts_lib_c404 from table @lt_clnts_lib.
...
******** ztlibros_c404 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztlibros_c404.
    insert ztlibros_c404 from table @lt_libros.
