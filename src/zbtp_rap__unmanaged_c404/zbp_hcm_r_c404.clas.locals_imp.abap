CLASS lcl_buffer DEFINITION.
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_buffer.
             INCLUDE TYPE zhcm_master_c404 AS data.
...
CLASS lhc_HCM IMPLEMENTATION.
  ...
  METHOD create.
    ...
    LOOP AT entities INTO DATA(ls_entities).
      ...
      INSERT VALUE #( flag = lcl_buffer=>created
                      ...
                      data-crea_uname = ls_entities-%data-CreaUname ) INTO TABLE lcl_buffer=>it_buffer_master.
  ...
  METHOD update.
    ...
    LOOP AT entities INTO DATA(ls_entities).
      ...
      SELECT SINGLE * FROM zhcm_master_c404
  ...
  METHOD delete.
    ...
    LOOP AT keys INTO DATA(ls_entities).
      ...
      INSERT VALUE #( flag = lcl_buffer=>deleted
                      data-e_number = ls_entities-ENumber ) INTO TABLE lcl_buffer=>it_buffer_master.
...
CLASS lsc_ZHCM_R_C404 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZHCM_R_C404 IMPLEMENTATION.
  ...
  METHOD save.
    ...
    DATA: lt_data_created TYPE STANDARD TABLE OF zhcm_master_c404,
          lt_data_updated TYPE STANDARD TABLE OF zhcm_master_c404,
          lt_data_deleted TYPE STANDARD TABLE OF zhcm_master_c404.
...
* Create
    ...
    IF lt_data_created IS NOT INITIAL.
      INSERT zhcm_master_c404 FROM TABLE @lt_data_created.
    ENDIF.
...
* Update
    ...
    IF lt_data_updated IS NOT INITIAL.
      UPDATE zhcm_master_c404 FROM TABLE @lt_data_updated.
    ENDIF.
...
* Delete
    ...
    IF lt_data_deleted IS NOT INITIAL.
      DELETE zhcm_master_c404 FROM TABLE @lt_data_deleted.
    ENDIF.
