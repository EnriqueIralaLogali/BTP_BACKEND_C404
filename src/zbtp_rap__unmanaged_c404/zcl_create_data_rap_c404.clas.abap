CLASS zcl_create_data_rap_c404 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_create_data_rap_c404 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DELETE FROM zhcm_master_c404.

    MODIFY zhcm_master_c404 FROM @( VALUE #( e_number =  '00000001'
                                     e_name         = 'Lorena Perez'
